...
## Connections
- Related papers: [[2410-Pi0]]（同为 VLM + flow matching VLA，GR00T N1 可视为其 humanoid 版本）, [[2504-Pi05]]（π0.5，加入 high-level reasoning）, [[2511-PiStar06]]（π0.6，加入 online learning）, [[2405-Octo]]（cross-embodiment baseline）, [[2406-OpenVLA]]（VLA baseline）, [[2502-OpenVLA-OFT]]（OpenVLA fine-tuning）, [[2506-SmolVLA]]（轻量 VLA）, [[2412-RoboVLMs]]（VLA 统一框架）, [[2505-DreamGen]]（neural trajectory generation 相关）, [[2504-UWM]]（unified world model, latent action 相关）, [[2512-Motus]]（action tokenization 相关）, [[2502-HiRobot]]（cross-embodiment）, [[2501-Cosmos]]（NVIDIA world model）
- Related ideas: Diffusion Policy, DexMimicGen, Action Chunking, VQ-VAE action tokenization
- Related projects:
