...
> - **Sources**: [arxiv](https://arxiv.org/abs/2311.12871) | [website](https://embodied-generalist.github.io/) | [github](https://github.com/embodied-generalist/embodied-generalist)

---
## Summary

LEO 是首个能在 3D 世界中完成感知、grounding、推理、规划和行动全链路任务的 embodied multi-modal generalist agent，通过 object-centric 3D 表示连接 LLM，以统一的架构和训练目标同时处理 3D VL 理解和 embodied action 生成。
